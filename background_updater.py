#!/usr/bin/env python3
"""
Background updater for all remaining players
"""
...
def background_update():
    """Update all remaining players in background"""
    ...
    while running:
        try:
            ...
            if not players:
                print(f"All players updated! Total: {total_updated}")
                break
    ...
    print(f"Background update completed: {total_updated} players updated")
